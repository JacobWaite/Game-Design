...
ASSET_MANAGER.queueDownload("./Paladin_Idle.png");
...
ASSET_MANAGER.downloadAll(() => {
	...
	gameEngine.init(ctx);
	gameEngine.addEntity(new Paladin(gameEngine,50,50, ASSET_MANAGER.getAsset("./Paladin_Idle.png"), 17, 40, 16, 24, 100, 20, 10, 10));
